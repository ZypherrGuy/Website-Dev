...
namespace ZMS
{
  ...
  {
    //Get count data
    public string query_countOrderCategoryCode_BLG = "Select COUNT(*) FROM tb_orders WHERE type_abr = 'blog Post'";
